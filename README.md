...
This article contains ideas for setting up a projects structure and a naming convention for scripts and assets in Unity. It is derived from [ninito-ph's](https://github.com/ninito-ph/Unity-Style-Guide) version of [justinwasilenko's](https://github.com/justinwasilenko/Unity-Style-Guide) Unity Style Guide. This version of the guide has a few changes compared to the original.
